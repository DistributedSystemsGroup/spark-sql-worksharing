% The leaf node represents the base relation. The root node represents the query. Each itermediate node is marked by a relational algebra operation. 
% conservative rather than 
% benefit per unit space

% Query Q is called a consumer of CE ce if it can be answered using ce. 
